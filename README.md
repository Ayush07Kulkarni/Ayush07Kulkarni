...
&nbsp;
<a href="mailto:ayushkulkarni3755@gmail.com">
<img src="https://img.shields.io/badge/Gmail-ayushkulkarni3755-EA4335?style=for-the-badge&logo=gmail&logoColor=white&labelColor=0d1117"/>
</a>
...
class AyushKulkarni:
    def __init__(self):
        self.name         = "Ayush Kulkarni"
        self.role         = "AI Engineer | Computer Vision Researcher"
        self.education    = "Electronics & Computer Engineering (2027)"
        self.cgpa         = 9.465
        self.location     = "India 🇮🇳"
    ...
    def Current_focus(self):
        return [
            ...
            "Edge AI Deployment → TensorRT, ONNX, Quantization, Pruning",
            "Multi-Agent Systems → Orchestration, Tool-Calling, Planning",
            "Autonomous Systems → Robotics, Sensor Fusion, Path Planning",
            "Vision Language Models → CLIP, LLaVA, Grounding DINO",
            "Applied ML Research → Closing the Gap from Lab to Deployment",
        ]
...
![CrewAI](https://img.shields.io/badge/CrewAI-4A90E2?style=for-the-badge&logo=crewai&logoColor=white)
...
![LoRA](https://img.shields.io/badge/LoRA-FF9800?style=for-the-badge&logo=pytorch&logoColor=white)

</div>

---

### 👁️ Computer Vision & Specialized Models

<div align="center">

![YOLO](https://img.shields.io/badge/YOLOv11-111111?style=for-the-badge&logo=yolo&logoColor=00f5ff)
...
### 🏢 Thelios AI — Computer Vision & AI Engineering Intern

> *Building end-to-end sports analytics AI systems*
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-Connect-0077B5?style=for-the-badge&logo=linkedin)](https://www.linkedin.com/in/ayushkulkarni07)
[![Email](https://img.shields.io/badge/Email-Reach_Out-EA4335?style=for-the-badge&logo=gmail)](mailto:ayushkulkarni3755@gmail.com)
